        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading"><h1>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}'s
                            Dashboard</h1></div>
                    ...
                    <div class="panel-body">
                        <div class="row text-center">
                            <div class="row text-center">
                                <div class="col-sm-4">
                                    <input type="button" value="Toggle QR Code" class="btn btn-info btn-lg"
                                           onclick="ShowQRCode()"/>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="button" value="Print My QR Code" class="btn btn-info btn-lg"
                                           onclick="PrintImage()"/>
                                </div>
                            </div>
                        ...
                        <div class="row text-center" id="become-an-affiliate">
                            ...
                            <div class="row text-center">
                                <div class="col-sm-5 col-md-offset-1">
                                    <p>Would you like to sign other people up and earn cash every time they use their card?</p>
                                    <input type="button" value="Apply As Affiliate" class="btn btn-success btn-lg"
                                           data-toggle="modal" data-target="#myModal" onclick="hideAffiliate()"/>
                                </div>
                                <div class="col-sm-5">
                                    <img class="img-responsive center-block" src="{{asset('images/card-fan.png')}}">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Thank you for applying to become an affiliate. You've been placed into queue for our screening
                    process. A customer representative will contact you shortly to determine if you qualify.
                </div>
